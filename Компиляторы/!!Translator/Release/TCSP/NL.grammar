...
Assign                   
                         ...
                         ;
QuestionList             
                         :   <Priority,Question>         Question                    <Separator,Colon>           Question                    { MAKE(Question); }      
                         |   
                         ;
Question                 
                         :   OrOr                        QuestionList             
...
ForPostfix               
                         ...
                         ;
ForStmnt                 
                         :   <Reserv,For>                <Separator,LeftBracket>     ForPrefix                   ForCondition                ForPostfix                  DefExpr                     { MAKE(For); }           
                         ;
DoStmnt                  
                         :   <Reserv,Do>                 DefExpr                     <Reserv,While>              <Separator,LeftBracket>     Condition                   <Separator,RightBracket>    <Separator,Semicolon>       { MAKE(Do); }            
                         ;
WhileStmnt               
                         :   <Reserv,While>              <Separator,LeftBracket>     Condition                   <Separator,RightBracket>    DefExpr                     { MAKE(While); }         
                         ;
SwitchStmnt              
