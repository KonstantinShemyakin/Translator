...
BodyFunc                 
                         ...
                         ;
DefFuncParBody           
                         :   <Separator,RightBracket>    { TREE(EndParams); }        { NODE(Define,(0)); }    
...
DefVarIdent              
                         ...
                         ;
DefVarAssign             
                         :   DefVarIdent                 <Oper,Assign>               { CODE(BegDefVarAssign); }                              Assign                      { MAKE(DefVarAssign); }     { NODE(DefVar,(2,1,3),2); }                          
                         ;
DefVar                   
                         :   DefVarAssign             
                         |   DefVarIdent              
...
Assign                   
                         ...
                         ;
Question                 
                         :   OrOr                        PriorQuestion               { CODE(BegQuestion); }      Question                    <Separator,Colon>           { CODE(MidQuestion); }      Question                    { MAKE(Question); }         { NODE(Trio,(2,1,3,5)); }
                         |   OrOr                     
                         ;
OrOr                     
...
ForPostfix               
                         ...
                         ;
ForStmnt                 
                         :   <Reserv,For>                <Separator,LeftBracket>     { CODE(BegFor); }           ForPrefix                   { CODE(PrefFor); }          ForCondition                { CODE(ConditionFor); }     ForPostfix                  { CODE(PostFor); }          DefExpr                     { MAKE(For); }              { NODE(For,(1,3,4,5,6)); }                           
                         ;
DoStmnt                  
                         :   <Reserv,Do>                 DefExpr                     <Reserv,While>              <Separator,LeftBracket>     Condition                   <Separator,RightBracket>    <Separator,Semicolon>       { MAKE(Do); }               { NODE(Do,(1,5,2)); }    
                         ;
WhileStmnt               
                         :   <Reserv,While>              <Separator,LeftBracket>     Condition                   <Separator,RightBracket>    DefExpr                     { MAKE(While); }            { NODE(While,(1,3,5)); } 
                         ;
GoToStmnt                
...
ReturnValue              
                         ...
                         ;
ReturnStmnt              
                         :   <Reserv,Return>             ReturnValue                 { NODE(None,(2)); }      
                         ;
BegIfStmnt               
