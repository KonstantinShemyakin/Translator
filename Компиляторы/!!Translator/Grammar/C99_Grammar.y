...
%token BOOL                  1829 // 0725
%token COMPLEX               1830 // 0726
%token IMAGINARY             1831 // 0727
%token INLINE                1832 // 0728
%token RESTRICT              1833 // 0729

%token IDENTIFIER            1536 // 0600
%token TYPE_NAME             1537 // 0601
%token DECLARATOR            1538 // 0602
%token ENUMERATOR            1539 // 0603
...
compound_statement
	...
	| { TREE(LexTypeName,T_Lex::BegBlock); } '{' block_item_list { TREE(LexTypeName,T_Lex::EndBlock); } '}'
	;
...
function_definition
	: declaration_specifiers declarator declaration_list { TREE(LexTypeName,T_Lex::BegFunc); } compound_statement { TREE(LexTypeName,T_Lex::EndFunc); }
