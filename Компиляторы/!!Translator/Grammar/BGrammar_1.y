...
S_                   : bnf                        
                     ;
bnf                  : bnf                      rules              { NODE(Formula,(0,1,2),1); }
                     | { NODE(Formula,(0),6); }
                     ;
rules                : rules                    <Oper,Or>          symbol_list                    { NODE(Formula,(0,1,3),1); }
                     | rule                     { NODE(Formula,(0,1),7); }
                     ;                          
rule                 : <Space>                  <Separator,BNFSet> symbol_list                    { NODE(Formula,(1,3),2); }
                     ;                          
symbol_list          : symbol_list              produce_item       { NODE(Produce,(2,1),7); }
                     | { NODE(Produce,(0),6); }
                     ;
...
Maker_Make:            <Separator,LeftCramp>    Ident_Maker                  <Separator,LeftBracket>       <Ident>                <Separator,Comma>               int_body                       <Separator,RightBracket>     <Separator,Semicolon>        <Separator,RightCramp>       { NODE(Maker,(2,4,6),0); }
                     | <Separator,LeftCramp>    Ident_Maker                  <Separator,LeftBracket>       <Ident>                <Separator,RightBracket>        <Separator,Semicolon>          <Separator,RightCramp>       { NODE(Maker,(2,4),0); }
                     ;
...
Maker_Node:            <Separator,LeftCramp>    <Reserv,Node>                <Separator,LeftBracket>       <Ident>                <Separator,Comma>               node_body                      <Separator,Comma>            int_body                     <Separator,RightBracket>     <Separator,Semicolon>        <Separator,RightCramp>       { NODE(Maker,(4,6,8),1); }
                     | <Separator,LeftCramp>    <Reserv,Node>                <Separator,LeftBracket>       <Ident>                <Separator,Comma>               node_body                      <Separator,RightBracket>     <Separator,Semicolon>        <Separator,RightCramp>       { NODE(Maker,(4,6),1); }
                     ;
...
Maker_Turn:            <Separator,LeftCramp>    <Reserv,Turn>                <Separator,LeftBracket>       <Ident>                <Separator,Comma>               <Ident>                        <Separator,Comma>            int_body                     <Separator,RightBracket>     <Separator,Semicolon>        <Separator,RightCramp>       { NODE(Maker,(4,6,8),5); }
                     | <Separator,LeftCramp>    <Reserv,Turn>                <Separator,LeftBracket>       <Ident>                <Separator,Comma>               <Ident>                        <Separator,RightBracket>     <Separator,Semicolon>        <Separator,RightCramp>       { NODE(Maker,(4,6),5); }
                     ;

Maker_Call:            <Separator,LeftCramp>    <Reserv,Call>                <Separator,LeftBracket>       <Ident>                <Separator,Comma>               int_body                        <Separator,Comma>            int_body                     <Separator,RightBracket>     <Separator,Semicolon>        <Separator,RightCramp>       { NODE(Maker,(4,6,8),6); }
                     | <Separator,LeftCramp>    <Reserv,Call>                <Separator,LeftBracket>       <Ident>                <Separator,Comma>               int_body                        <Separator,RightBracket>     <Separator,Semicolon>        <Separator,RightCramp>       { NODE(Maker,(4,6),6); }
                     ;
